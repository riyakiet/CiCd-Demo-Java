        ...
        stage('Build') { 
            steps { 
                script{
                 ...
                 sh 'docker images'
                 docker tag "nuvepro-${BUILD_ID}" 418843764796.dkr.ecr.ap-south-1.amazonaws.com/nuvepro:nuvepro-${BUILD_ID}
                 docker push 418843764796.dkr.ecr.ap-south-1.amazonaws.com/nuvepro:nuvepro-${BUILD_ID}   
